...
//Las características principales de una Arquitectura Limpia está en el diseño de la aplicación, es como nosotros
// conceptualmente hemos diseñado el programa para que a través de una entrada se generen unos eventos y se
// produzcan salidas. Y se basa en la premisa de estructurar el códogo en capas contiguas:
// Capa de Entidades, Capa de Lógica de Aplicación, Capa de Interfaces Adaptadoras y Capa de Frameworks.
